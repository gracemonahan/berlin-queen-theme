<header class="banner">
  <div class="text-white container font-brand mx-auto bg-black py-5 flex justify-between justify-center">
    <a class="brand flex pl-5" href="{{ home_url('/') }}">
      ...
      <div class="pl-5 font-extrabold tracking-wide">{{ $siteName }}</div>
    </a>
    <nav class="nav-primary text-white font-brand uppercase">
      @if (has_nav_menu('primary_navigation'))
        {!! wp_nav_menu(['theme_location' => 'primary_navigation', 'menu_class' => 'text-bold flex flex-row', 'echo' => false, 'container' => false]) !!}
      @endif
    </nav>

  </div>
</header>
{!! wp_nav_menu(['theme_location' => 'primary_navigation', 'menu_class' => 'nav flex flex-row', 'echo' => false]) !!}
